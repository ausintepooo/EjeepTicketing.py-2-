...
# Introduction 
The Ejeep Ticketing System is a Python-based terminal application  
design to help jeepney or transport operators manage passenger  
fares for the starmall ↔ sampol route.  
